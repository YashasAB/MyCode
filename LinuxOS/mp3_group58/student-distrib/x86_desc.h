...
/* Quantify the different IDT types */
#define TASK_IDT       0
#define INTERRUPT_IDT  1
#define TRAP_IDT       2
#define SYS_IDT        3
...
// extern idt_desc_t idt_sys_call_ptr;

/* Sets runtime parameters for an IDT entry */
#define SET_IDT_ENTRY(str,handler,type)                              \
do {                                                                 \
    if(((uint8_t)(type)) == TASK_IDT)  {                             \
        str.size      = 0x0;                                         \
        str.reserved2 = 0x0;                                         \
        str.reserved3 = 0x1;                                         \
        str.dpl       = 0x0;                                         \
    }                                                                \
    if(((uint8_t)(type)) == INTERRUPT_IDT)  {                        \
