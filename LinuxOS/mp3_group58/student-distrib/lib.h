...
/* Bit-wise operation constants */
#define LOW_BYTE_MASK        0xFF
#define GET_SECOND_BYTE      8
...
uint32_t get_screen_x(void);
uint32_t get_screen_y(void);
...
/* Writes a byte to a port then pause (for older hardware) */
