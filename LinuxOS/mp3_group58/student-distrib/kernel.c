...
void entry(unsigned long magic, unsigned long addr) {
    ...
    if (CHECK_FLAG(mbi->flags, 3)) {
        ...
        file_boot((uint8_t *)mod->mod_start); 
    ...
    /* Initialize the PCB to NULL */
    pcb = NULL;
    
    // format for the IDT for system calls
    // {
    //     idt_desc_t sys_call_whatever;
    //     idt_sys_call_ptr = sys_call_whatever;
    // }
